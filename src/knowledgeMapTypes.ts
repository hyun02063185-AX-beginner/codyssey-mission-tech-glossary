...
export type RegistryMap = { mapId: string; fieldId: string; title: string; description: string; status: 'implemented' | 'planned' | 'review-required' | 'cross-field-candidate' | 'cross-field-layer'; availableMissions: string[]; fieldTermCount?: number; nodeCount?: number; termIds?: string[]; overlays?: Array<{ missionId: string; termIds: string[] }> };
