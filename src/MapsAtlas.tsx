...
const statusLabel = { implemented: '구현됨', planned: '준비 중', 'review-required': '검토 중', 'cross-field-candidate': '공통 계층 검토' } as const;
...
export default function MapsAtlas() {
  const groups = [['implemented', '구현된 지도'], ['planned', '준비 중인 지도'], ['review-required', '검토 중인 지도'], ['cross-field-candidate', '공통 계층 후보']] as const;
