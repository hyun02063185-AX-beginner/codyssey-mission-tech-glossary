...
호스트의 포트를 컨테이너 안 서비스 포트와 연결하는 설정.
...
호스트의 포트를 컨테이너 안 서비스 포트와 연결하는 설정. 구현 방법은 언어와 도구에 따라 달라도, 미션 요구사항에서 맡는 역할과 한계는 구분해서 설명할 수 있어야 합니다.

## 이 미션에서는 왜 필요한가

preliminary M01: 4.8 브라우저 또는 curl 접속 증거 필요
