...
두 값을 곱한 뒤 누적해 더하는 multiply-accumulate 연산.
...
두 값을 곱한 뒤 누적해 더하는 multiply-accumulate 연산. 구현 방법은 언어와 도구에 따라 달라도, 미션 요구사항에서 맡는 역할과 한계는 구분해서 설명할 수 있어야 합니다.

## 이 미션에서는 왜 필요한가

preliminary M03: 반복문으로 직접 구현하라는 최우선 조건
