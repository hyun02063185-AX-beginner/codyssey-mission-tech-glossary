...
Docker은(는) 코디세이 미션에서 반복해 쓰이는 핵심 개념입니다.
...
Docker은(는) 코디세이 미션에서 반복해 쓰이는 핵심 개념입니다. 구현 방법은 언어와 도구에 따라 달라도, 미션 요구사항에서 맡는 역할과 한계는 구분해서 설명할 수 있어야 합니다.

## 이 미션에서는 왜 필요한가

main M08: 격리 환경 권장; preliminary M01: 4.4\~4.9 전 항목의 중심 도구
