...
셸을 실행하고 입출력을 보여 주는 창 또는 응용 프로그램.
...
셸을 실행하고 입출력을 보여 주는 창 또는 응용 프로그램. 구현 방법은 언어와 도구에 따라 달라도, 미션 요구사항에서 맡는 역할과 한계는 구분해서 설명할 수 있어야 합니다.

## 이 미션에서는 왜 필요한가

preliminary M01: README 실행환경 항목에 OS/셸/터미널 기재 요구
