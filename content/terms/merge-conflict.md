...
`merge conflict`은(는) 변경을 기록하고 동료와 안전하게 공유하는 Git 작업 흐름의 한 부분입니다.

## 정확한 설명

같은 변경 위치를 Git이 자동으로 합칠 수 없어 사람이 선택해야 하는 상태. local history, remote state, review 규칙의 역할을 구분해 사용해야 합니다.
