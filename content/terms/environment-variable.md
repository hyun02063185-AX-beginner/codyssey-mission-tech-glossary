...
코드 밖에서 실행 환경별 설정값을 전달하는 값. 구현 방법은 언어와 도구에 따라 달라도, 미션 요구사항에서 맡는 역할과 한계는 구분해서 설명할 수 있어야 합니다.

## 이 미션에서는 왜 필요한가

main M02: API Key 민감정보 관리; main M06: API Key 관리; main M07: AGENT_* 경로·포트 설정; preliminary M01: 보너스. Compose 환경변수 전달
