...
`approve`은(는) 변경을 기록하고 동료와 안전하게 공유하는 Git 작업 흐름의 한 부분입니다.

## 정확한 설명

pull request 변경을 검토한 사람이 병합 가능 여부를 표시하는 review 결정. local history, remote state, review 규칙의 역할을 구분해 사용해야 합니다.
