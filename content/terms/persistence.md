...
프로그램이나 컨테이너가 끝난 뒤에도 필요한 데이터가 남는 성질.
...
프로그램이나 컨테이너가 끝난 뒤에도 필요한 데이터가 남는 성질. 구현 방법은 언어와 도구에 따라 달라도, 미션 요구사항에서 맡는 역할과 한계는 구분해서 설명할 수 있어야 합니다.

## 이 미션에서는 왜 필요한가

main M03: transactions/categories/budgets 저장; preliminary M01: 볼륨·바인드 마운트 증거의 목적; preliminary M02: 프로그램 종료 후에도 상태 유지
