...
Exception Handling은(는) 코디세이 미션에서 반복해 쓰이는 핵심 개념입니다.
...
Exception Handling은(는) 코디세이 미션에서 반복해 쓰이는 핵심 개념입니다. 구현 방법은 언어와 도구에 따라 달라도, 미션 요구사항에서 맡는 역할과 한계는 구분해서 설명할 수 있어야 합니다.

## 이 미션에서는 왜 필요한가

main M03: 입력·파일 오류 처리 확장; preliminary M02: 잘못된 입력에도 프로그램이 죽지 않아야 함
