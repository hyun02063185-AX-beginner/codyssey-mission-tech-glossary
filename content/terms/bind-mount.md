...
호스트의 특정 경로를 컨테이너에 직접 연결하는 방식. 구현 방법은 언어와 도구에 따라 달라도, 미션 요구사항에서 맡는 역할과 한계는 구분해서 설명할 수 있어야 합니다.

## 이 미션에서는 왜 필요한가

preliminary M01: 최종 결과물 7번 및 체크리스트. 호스트 변경 전후 비교
