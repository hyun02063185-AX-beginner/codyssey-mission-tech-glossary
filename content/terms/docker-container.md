...
이미지에서 만들어져 실행되는 격리된 프로세스 환경. 구현 방법은 언어와 도구에 따라 달라도, 미션 요구사항에서 맡는 역할과 한계는 구분해서 설명할 수 있어야 합니다.

## 이 미션에서는 왜 필요한가

main M05: EC2 내부 컨테이너 배포 보너스; preliminary M01: 4.6 실행·진입, 4.9 삭제 후 데이터 유지 증명
