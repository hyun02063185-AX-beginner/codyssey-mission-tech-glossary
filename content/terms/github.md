...
Git 저장소를 호스팅하고 협업 기능을 제공하는 서비스.
...
Git 저장소를 호스팅하고 협업 기능을 제공하는 서비스. 구현 방법은 언어와 도구에 따라 달라도, 미션 요구사항에서 맡는 역할과 한계는 구분해서 설명할 수 있어야 합니다.

## 이 미션에서는 왜 필요한가

preliminary M01: 저장소 링크로 제출. Git과 구분해 설명해야 함
