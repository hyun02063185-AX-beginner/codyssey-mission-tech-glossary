...
외부 API 사용자를 식별하거나 사용량을 제어하는 비밀 값.
...
외부 API 사용자를 식별하거나 사용량을 제어하는 비밀 값. 구현 방법은 언어와 도구에 따라 달라도, 미션 요구사항에서 맡는 역할과 한계는 구분해서 설명할 수 있어야 합니다.

## 이 미션에서는 왜 필요한가

main M02: Supabase/Firebase 연결 시 민감정보의 의미 이해; main M06: AI API 인증 정보
