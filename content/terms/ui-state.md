...
로딩·성공·오류·빈 결과처럼 화면이 현재 처한 상태. 구현 방법은 언어와 도구에 따라 달라도, 미션 요구사항에서 맡는 역할과 한계는 구분해서 설명할 수 있어야 합니다.

## 이 미션에서는 왜 필요한가

main M01: API 호출 상태 UI; main M01: API 호출 상태 UI; main M01: API 실패 상태 UI; main M01: 데이터 없음 상태 UI

## 관련 용어

로딩 상태, 성공 상태, 에러 상태, 빈 상태
