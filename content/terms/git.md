...
변경 이력을 분산 저장하고 협업을 돕는 버전 관리 시스템.
...
변경 이력을 분산 저장하고 협업을 돕는 버전 관리 시스템. 구현 방법은 언어와 도구에 따라 달라도, 미션 요구사항에서 맡는 역할과 한계는 구분해서 설명할 수 있어야 합니다.

## 이 미션에서는 왜 필요한가

main M04: 협업 형상관리 기반; main M10: Mini Git 모사 대상; preliminary M01: 4.10 연동 증거. GitHub와의 역할 차이 설명 요구
