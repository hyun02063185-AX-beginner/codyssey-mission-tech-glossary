...
CRUD은(는) 코디세이 미션에서 반복해 쓰이는 핵심 개념입니다.
...
CRUD은(는) 코디세이 미션에서 반복해 쓰이는 핵심 개념입니다. 구현 방법은 언어와 도구에 따라 달라도, 미션 요구사항에서 맡는 역할과 한계는 구분해서 설명할 수 있어야 합니다.

## 이 미션에서는 왜 필요한가

main M02: 단일 핵심 데이터 생성·조회·수정·삭제; main M03: add/list/update/delete 기능의 상위 개념; main M12: 단일 모델 생성·조회·수정·삭제
