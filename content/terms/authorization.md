...
확인된 사용자가 특정 기능을 사용할 권한이 있는지 판단하는 과정.
...
확인된 사용자가 특정 기능을 사용할 권한이 있는지 판단하는 과정. 구현 방법은 언어와 도구에 따라 달라도, 미션 요구사항에서 맡는 역할과 한계는 구분해서 설명할 수 있어야 합니다.

## 이 미션에서는 왜 필요한가

main M13: 기능 접근 권한 판단
