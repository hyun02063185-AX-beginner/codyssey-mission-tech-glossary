...
`Branch Protection Rule`은(는) 변경을 기록하고 동료와 안전하게 공유하는 Git 작업 흐름의 한 부분입니다.

## 정확한 설명

main 같은 branch에 review·status check·push 제한을 적용하는 rule. local history, remote state, review 규칙의 역할을 구분해 사용해야 합니다.
