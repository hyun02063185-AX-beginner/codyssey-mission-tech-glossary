...
`GitHub Flow`은(는) 변경을 기록하고 동료와 안전하게 공유하는 Git 작업 흐름의 한 부분입니다.

## 정확한 설명

짧은 feature branch와 pull request로 main에 자주 병합하는 협업 흐름. local history, remote state, review 규칙의 역할을 구분해 사용해야 합니다.
